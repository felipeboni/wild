...
import { ArrowRight, Eye, User, GitMerge, Shuffle } from "react-feather";
...
function Register() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    lastName: Yup
      ...
      .max(40)
      .required(),
    username: Yup.string().required("Insira o seu nickname"),
    password: Yup.string()
          ...
          {step === 2 && (
            ...
            >
              <div className="mx-auto relative">
                <Avatar className="w-32 h-32 ring-offset-4 ring-4 ring-primary-500" {...config} />
                <Shuffle
                size={18}
                color="gray"
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <h2 className="text-4xl font-medium">Conecte-se ao seu perfil da Steam&reg;</h2>
                <span>Fique tranquilo! Nós teremos acesso apenas á suas informações públicas - como nome do perfil, status online, entre outros.</span>
                <span>Você pode ver em detalhes todos os dados que coletamos <Link className="text-primary-500" href="#">clicando aqui.</Link></span>
              </div>
